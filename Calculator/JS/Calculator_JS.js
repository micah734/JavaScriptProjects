...
function Input_Digit(digit) {
    ...
    //checking to see if Wait is true and set
...
function Input_Decimal(dot) {
    //this ensures that accidental clicking of the dcimal point doesn't cause bugs in your operation
    if (Calculator.Wait_Second_Operand === true) return;
    if (!Calculator.Display_Value.includes(dot)) {
        //we are saying that if the Display_Value does not contain a decimal point want to add a decimal
